...
<div class="container" style="background: white;border-bottom: 1px solid black;">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" role="form" method="post" action="traitementDeleteCategorie.php" id="formuLogin">
                <div class="form-group">
                    <div class="col-md-1 col-md-offset-2">
                        <input id="supprimer" name="supprimer" type="submit" value="Supprimer categorie" class="btn btn-danger">
                    </div>
                </div>
            </form>
        </div>
